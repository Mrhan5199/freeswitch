...
local result = api:executeString("bgapi originate "..result[1].contact.." "..callee.." XML callcenter_agent_click_ctx zswitch_callcenter_agent_click "..hideNumber);
stream:write(result);
